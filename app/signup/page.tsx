      ...
      <Card className="w-full max-w-md" data-testid="card-signup">
        <CardHeader className="space-y-1">
          ...
          <CardDescription className="text-center">
            Sign up for ApexContent Engine
          </CardDescription>
        </CardHeader>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              {password.length > 0 && (
                <div className="space-y-1 text-sm mt-2">
                  ...
                  <PasswordRequirement met={passwordRequirements.hasSpecialChar}>
            ...
            <div className="space-y-2">
              ...
              {confirmPassword.length > 0 && (
                <PasswordRequirement met={doPasswordsMatch}>
                  Passwords match
                </PasswordRequirement>
              )}
            </div>
...
function PasswordRequirement({ met, children }: { met: boolean; children: React.ReactNode }) {
  return (
    <div className="flex items-center gap-2">
      ...
      <span className={met ? "text-green-500" : "text-muted-foreground"}>{children}</span>
    </div>
  );
}
