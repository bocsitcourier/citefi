...
import { useAgencyClientWorkspaces, useCreateCampaign } from "../use-campaigns";
...
export default function NewCampaignPage() {
  ...
  const agencyClients = useAgencyClientWorkspaces();
  ...
  const activeAgencyClients = agencyClients.data?.clients.filter(client => client.clientStatus === "active") ?? [];
